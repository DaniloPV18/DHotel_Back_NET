...
namespace DHotelBack.Migrations
{
    ...
    [Migration("20240121025438_Tabla_AbonoReserva_campos_agregados")]
    partial class TablaAbonoReservacamposagregados
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DHotel_Back.Models.Administrador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(713),
                            GeneroId = 2,
                            Nombres = "Micaela",
                            Pwd = "0931600548",
                            RolId = 1
                        ...
                        new
                        {
                            ...
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(724),
                            GeneroId = 2,
                            Nombres = "Sonia",
                            Pwd = "0931600549",
                            RolId = 2
                        ...
                        new
                        {
                            ...
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(726),
                            GeneroId = 1,
                            Nombres = "Milo",
                            Pwd = "0931600550",
                            RolId = 1
            ...
            modelBuilder.Entity("DHotel_Back.Models.Habitacion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(859),
                            Numero = 400
                        },
                        new
                        {
                            Id = 2,
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(886),
                            Numero = 401
                        },
                        new
                        {
                            Id = 3,
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(887),
                            Numero = 402
                        });
                });
            ...
            modelBuilder.Entity("DHotel_Back.Models.HabitacionServicioOfrecido", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(898)
                        },
                        new
                        {
                            HabitacionId = 1,
                            ServicioOfrecidoId = 2,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(899)
                        });
                });
            ...
            modelBuilder.Entity("DHotel_Back.Models.Huesped", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(825),
                            GeneroId = 2,
                            Nombres = "Keila"
                        },
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(827),
                            GeneroId = 1,
                            Nombres = "Alejandro"
                        },
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(828),
                            GeneroId = 1,
                            Nombres = "Pepe"
                        });
                });
            ...
            modelBuilder.Entity("DHotel_Back.Models.ServicioOfrecido", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Codigo = "NET",
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(845),
                            Nombre = "Internet"
                        },
                        new
                        {
                            ...
                            Codigo = "TV",
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(846),
                        ...
                        new
                        {
                            ...
                            Codigo = "AIR",
                            EstadoId = 1,
                            FechaRegistro = new DateTime(2024, 1, 20, 21, 54, 37, 891, DateTimeKind.Local).AddTicks(847),
